...
import { useDialogDeleteProblemCategory } from './useDialogDeleteProblemCategory'
...
export const DialogDeleteProblemCategory = ({ id, backFn }: Props) => {
  const { hideDialog } = useDialog()
  const [values, handles] = useDialogDeleteProblemCategory({ id, backFn })
