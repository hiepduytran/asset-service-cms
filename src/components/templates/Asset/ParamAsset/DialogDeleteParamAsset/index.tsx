...
import { useDialogDeleteParamAsset } from './useDialogDeleteParamAsset'
...
export const DialogDeleteParamAsset = ({ id, refetch }: Props) => {
  const { hideDialog } = useDialog()
  const [values, handles] = useDialogDeleteParamAsset({ id, refetch })
