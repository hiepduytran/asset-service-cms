...
import { useAnnualMaintenancePlanList } from './useAnnualMaintenancePlanList'
import CoreAutocomplete from '@/components/atoms/CoreAutocomplete'
import { planTypeOfMaintenancePlan } from '@/enum'

export default function AnnualMaintenancePlanList() {
  const [values, handles] = useAnnualMaintenancePlanList()
        ...
        <CoreBreadcrumbs
          breadcrumbs={[
            ...
            },
            {
              title: (
                <div className='flex gap-3 items-center'>
                  <Typography>{t('nav.maintenancePlanning')}</Typography>
                </div>
              ),
            },
          ]}
    ...
    >
      <div className='flex flex-col'>
        ...
        <div className='py-4 flex justify-end'>
          <CoreButton
            onClick={() =>
              router.push(`${MENU_URL.ANNUAL_MAINTENANCE_PLAN}/addNew`)
            }
          >
            {t('common:btn.add')}
          </CoreButton>
        ...
        <CoreTable
          tableName='annualMaintenancePlan'
          columns={columns}
          data={tableData}
