...
import useSelfMaintenanceFollowAction from './useSelfMaintenanceFollowAction'
import { getTitleBreadcrumbs } from '@/helper/getTitleBreadcrumbs'

export default function SelfMaintenanceFollowAction() {
  const [
    { methods, isView, isUpdate, step, isLoadingDetailMaintenancesCard },
    { t, onSubmit, handleChangeStep },
  ] = useSelfMaintenanceFollowAction()
  return (
    <PageContainer
      title={
        <CoreBreadcrumbs
          breadcrumbs={[
...

            {
              ...
              pathname:
                MENU_URL.MAINTENANCE.SELF_MAINTENANCE.SELF_MAINTENANCE_FOLLOW,
            },
            {
