...
import { useMaintenanceAccessoryList } from './useMaintenanceAccessoryList'
import TableCustom from './TableCustom'

export default function MaintenanceAccessoryList() {
  const router = useRouter()

  const [values, handles] = useMaintenanceAccessoryList()
      ...
      <div className='flex flex-col'>
        ...
        <div className='py-4 flex justify-end'>
          <div className='py-4 flex justify-end'>
            <CoreButton
              onClick={() =>
                router.push(`${MENU_URL.MAINTENANCE_ACCESSORY}/addNew`)
              }
            >
              {t('common:btn.add')}
            </CoreButton>
