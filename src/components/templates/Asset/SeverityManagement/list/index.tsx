...
import useSeverityManagement from './useSeverityManagement'

export default function SeverityManagement() {
  const [
    {
      methods,
      router,
      ...
      <div className='flex flex-col' onSubmit={onSubmit}>
        <form className='flex flex-col p-5'>
          ...
          <div className='flex justify-end mt-10 gap-10'>
            <CoreButton
              onClick={() => {
                router.push(`${MENU_URL.SEVERITY_MANAGEMENT}/addNew`)
              }}
              theme='submit'
            >
              {t('common:btn.add')}
