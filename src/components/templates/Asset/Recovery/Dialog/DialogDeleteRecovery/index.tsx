...
import { useDialogDeleteRecovery } from './useDialogDeleteStatus'
...
export const DialogDeleteRecovery = ({ id, backFn }: Props) => {
  const { hideDialog } = useDialog()
  const [values, handles] = useDialogDeleteRecovery({ id, backFn })
