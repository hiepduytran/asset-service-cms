...
import { useStandardDeclaration } from './useStandardDeclaration'
import CoreAutocomplete from '@/components/atoms/CoreAutocomplete'

export default function StandardDeclarationList() {
  const [values, handles] = useStandardDeclaration()
    ...
    >
      <div className='flex flex-col'>
        ...
        <div className='py-4 flex justify-end'>
          <CoreButton
            onClick={() =>
              router.push(`${MENU_URL.STANDARD_DECLARATION}/addNew`)
            }
          >
            {t('common:btn.add')}
          </CoreButton>
