...
import { useQueryGroupStandardList } from '@/service/asset/standardDeclaration/getList'
...
export const useStandardDeclaration = () => {
  ...
  const columns = useMemo(
    () =>
      [
        {
          header: t('table.codeGroup'),
          fieldName: 'code',
        },
        {
          header: t('table.nameGroup'),
          fieldName: 'name',
        },
        {
          header: t('table.createdAt'),
          fieldName: 'standardCreatedAt',
        },
        {
  ...
  const {
    ...
    data,
    refetch,
  } = useQueryGroupStandardList(queryPage)
