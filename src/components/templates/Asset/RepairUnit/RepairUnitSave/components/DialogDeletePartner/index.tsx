...
import { useDialogDeletePartner } from './useDialogDeletePartner'
...
export const DialogDeletePartner = ({ id, backFn }: Props) => {
  const { hideDialog } = useDialog()
  const [values, handles] = useDialogDeletePartner({ id, backFn })
