...
import { useFirstPeriodList } from './useFirstPeriodList'
import TableCustom from './TableCustom'

export default function FirstPeriodList() {
  const router = useRouter()

  const [values, handles] = useFirstPeriodList()
    ...
    >
      <div className='flex flex-col'>
        ...
        <div className='py-4 flex justify-end'>
          <div className='py-4 flex justify-end'>
            <CoreButton
              onClick={() => router.push(`${MENU_URL.FIRST_PERIOD}/addNew`)}
            >
              {t('common:btn.add')}
            </CoreButton>
          </div>
