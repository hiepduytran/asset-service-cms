...
import { useDialogDeleteProblem } from './useDialogDeleteStatus'
...
export const DialogDeleteProblem = ({ problemId, backFn }: Props) => {
  const { hideDialog } = useDialog()
  const [values, handles] = useDialogDeleteProblem({ problemId, backFn })
