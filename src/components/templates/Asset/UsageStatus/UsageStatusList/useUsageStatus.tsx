...
import { useQueryUsageStatusList } from '@/service/asset/usageStatus/getList'
import { RequestBody } from '@/service/asset/usageStatus/getList/type'
...
export const useUsageStatus = () => {
  ...
  const {
    ...
    data,
    refetch,
  } = useQueryUsageStatusList(queryPage)
