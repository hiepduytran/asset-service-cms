...
import { useDialogDeleteUsageStatus } from './useDialogDeleteStatus'
...
export const DialogDeleteUsageStatus = ({ id, backFn }: Props) => {
  const { hideDialog } = useDialog()
  const [values, handles] = useDialogDeleteUsageStatus({ id, backFn })
